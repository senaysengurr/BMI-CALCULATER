...
var height =document.getElementById('height').value;
 ...
 document.getElementById('result').innerText=result.toFixed(2);// toFixed ondalıklı sayının virgülden sonra 2 haneli olur.
if(result<18.5){
    document.getElementById('result-statu').innerText="Under Weight";
    document.getElementById('result-satutu').style.color='#2196f3';
